package clienteALaEscuchaProfeEj05;
...
public class ClienteUDP {
	...
	public static void main(String[] args) throws IOException {
		...
		InetAddress address = InetAddress.getByName("225.0.0.3"); //si cogemos una ip diferente no funcionará, está diseñado para eso
		multicastSocket.setInterface(InetAddress.getByName("172.30.164.7"));
